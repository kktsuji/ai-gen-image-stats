...
Key config sections: `experiment`, `mode` (train/generate/select), `compute`, `model`, `data`, `output`, `training`, `generation`, `logging`.
...
- Example config: `configs/sample-selection-example.yaml`
