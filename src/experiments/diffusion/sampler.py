...
This module implements standalone sampling functions for generating images from
trained diffusion models. It separates sampling/inference logic from training,
...
def sample(
    ...
    *,
    ...
    Example:
        ...
        >>> samples = sample(model, device="cpu", num_samples=64, use_ema=False)
    """
    # Validate inputs
    ...
    try:
        with torch.no_grad():
            ...
            # Generate samples
            samples = model.sample(  # type: ignore[operator]
    ...
    *,
    ...
    try:
        with torch.no_grad():
            ...
            all_steps = model.sample(  # type: ignore[operator]
                batch_size=num_samples,
                class_labels=class_labels,
                guidance_scale=guidance_scale,
...
def sample_by_class(
    ...
    *,
    ...
    Convenience function for generating balanced samples across all classes.
    ...
    Example:
        ...
        ...     model, "cuda", samples_per_class=4, num_classes=10,
        ...     guidance_scale=3.0, use_ema=True, ema=ema
        ... )
